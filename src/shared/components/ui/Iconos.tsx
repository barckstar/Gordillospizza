/*
  Iconos en SVG inline, no un paquete.

  Son cuatro. Traerse una libreria de iconos por cuatro trazos serian decenas
  de kilobytes y un `import` mas en el arbol del cliente; asi viajan dentro
  del HTML y no cuestan una peticion.

  Todos heredan el color con `currentColor` y llevan `aria-hidden`: la
  etiqueta accesible la pone quien los usa, que es donde se sabe a que enlace
  corresponden.
*/
